...
if __name__ == '__main__':
    import datetime
    print(datetime.datetime.isoformat(datetime.datetime.today()) + ': client_prompt_for_exit.py start')
    main()
    print(datetime.datetime.isoformat(datetime.datetime.today()) + ': client_prompt_for_exit.py end')
