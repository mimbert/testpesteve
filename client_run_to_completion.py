...
class client_run_to_completion(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "client-run-to-completion")
...
def main(top_block_cls=client_run_to_completion, options=None):
    tb = top_block_cls()
