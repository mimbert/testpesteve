...
if __name__ == '__main__':
    import datetime
    print(f"{datetime.datetime.isoformat(datetime.datetime.today())}: server-prompt-for-exit start")
    main()
    print(f"{datetime.datetime.isoformat(datetime.datetime.today())}: server-prompt-for-exit end")
